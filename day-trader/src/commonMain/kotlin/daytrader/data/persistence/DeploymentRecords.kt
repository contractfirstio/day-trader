...
data class TouchTurnRuleConfigRecord(
    ...
    val trailingActivateAfterMinutes: Int = 0,
    val trailingActivateClockBase: String = "SESSION_OPEN",
    val trailingRequirePriceTrigger: Boolean = true,
    ...
    val greenBodyRatioBelowAction: String = "OFF",
    val greenBodyRatioAboveAction: String = "OFF",
    val redBodyRatioBelowAction: String = "OFF",
    val redBodyRatioAboveAction: String = "OFF",

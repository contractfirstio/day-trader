...
data class StrategyConfigurationSnapshot(
    ...
    fun canonicalString(): String = buildString {
        ...
        touchTurnRules?.let { rules ->
            ...
            append("|trailingActivateAfterMinutes=").append(rules.trailingActivateAfterMinutes)
            append("|trailingActivateClockBase=").append(rules.trailingActivateClockBase.name)
            append("|trailingRequirePriceTrigger=").append(rules.trailingRequirePriceTrigger)
